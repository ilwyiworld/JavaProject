 ...
 *   2          1000        500        500
 */
public class CountMapReduceByTool extends Configured implements Tool{
    ...
    public static void main(String[] args) throws Exception{
        int status=ToolRunner.run(new CountMapReduceByTool(),args);
        //ToolRunner.run(new CountMapReduceByTool().getConf(),new CountMapReduceByTool(),args);
