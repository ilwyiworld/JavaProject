...
public class TestStayTimeStatNew {
    ...
    public static void addCoprocessor(String tableName) throws IOException {
        String coprocessorClassName = StayTimeStatNewImplementation.class.getName();
    ...
    private Map<StayTimeSearchOutData, List<StayTimeSearchOutData>> getStatResult(String tableName) {
        ...
        try {
            ...
            statData = client.getStayTimeStatNew(HBaseConfig.getTable(tableName), searchParam, newScan); // 协处理器中已排序
        } catch (Throwable e) {
            e.printStackTrace();
        }
        return statData;
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            TestStayTimeStatNew client = new TestStayTimeStatNew();
            Map<StayTimeSearchOutData, List<StayTimeSearchOutData>> statData = client.getStatResult(tableName);

            //获取leader信息
            List<StayTimeSearchOutData> leaderData = getLeaderData(statData);


            client.getDataFromHbase(leaderData, tableName);
    ...
    private static List<StayTimeSearchOutData> getLeaderData(Map<StayTimeSearchOutData, List<StayTimeSearchOutData>> dataListMap) {
