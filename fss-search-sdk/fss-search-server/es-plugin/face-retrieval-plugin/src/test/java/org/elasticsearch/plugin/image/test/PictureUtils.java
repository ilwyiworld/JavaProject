...
public class PictureUtils {
    public static final String url = "http://10.45.157.108:80/verify/feature/gets";
    // 银川动态服务器：10.110.10.241，
    // 南京：10.45.150.39
    // 新地址：10.45.154.53.108
    // 原地址：10.45.152.113
    // 1楼动态：10.45.157.114(256维)
    // 1楼静态：10.45.144.94
    // 9楼动态：10.45.144.95(256维)
    // 9楼静态：10.45.144.94
    ...
    public static String getStrFeature(String feature1) {
        ...
        String strFeature = "";
        if (feature1 != null && !feature1.equals("")) {
    ...
    public static void savePicture(byte[] image, int personId, String filePath) {
        ...
        if (!file.exists()) {
            file.mkdirs(); // windows下创建文件夹
        }

        try {
            String fileName = filePath + "\\" + Integer.toString(personId) + ".jpg";
            // System.out.println("total path:" + fileName);
    ...
    public static void main(String[] args) {
        // 输出float型feature
        File file = new File("E:\\FssProgram\\V1.0\\全表扫描\\相似度阈值测试\\11.jpg");
