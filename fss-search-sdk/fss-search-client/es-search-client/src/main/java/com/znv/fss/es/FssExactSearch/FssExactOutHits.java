...
public class FssExactOutHits {
    ...
    public void setTrack_idx(String track_idx) {
        this.track_idx = track_idx;
    }

    public String getTrack_idx() {
        return this.track_idx;
    }
    ...
    public String getTask_idx() {
        return this.task_idx;
    }

    public void setRt_feature(String rt_feature) {
        this.rt_feature = rt_feature;
    }

    public String getRt_feature() {
        return this.rt_feature;
    }
