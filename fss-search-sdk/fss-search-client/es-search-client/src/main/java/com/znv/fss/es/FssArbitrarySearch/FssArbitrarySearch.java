 ...
 */
public class FssArbitrarySearch extends BaseEsSearch {

    protected static final Logger LOGGER = LogManager.getLogger(FssArbitrarySearch.class);
    private String esurl;
    private String templateName;
    // private FssArbitraryJsonIn fssArbitratJsonIn;
    // private FssArbitraryQueryParam fssArbitraryQueryParam;

    public FssArbitrarySearch(String esurl, String tempalteName) {
        this.esurl = esurl;
    ...
    public JSONObject requestSearch(String params) {
        ...
        // String path = "/root/FSSTestClient/FSSConditionSearch/result/result.txt";
