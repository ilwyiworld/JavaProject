...
public class ConnectionPool {
    ...
    // 连接池的初始大小
    // private int initialConnections = ConfigManager.getInt(VConstants.SDK_CONNECTION_INITIAL_SIZE);
    private int initialConnections = ConfigManager.getPoolInt(VConstants.SDK_CONNECTION_INITIAL_SIZE); // 改成读工程中配置文件方式
    // 连接池自动增加的大小SDK_CONNECTION_INITIAL_SIZE
    private int incrementalConnections = 5;
    // 连接池最大的大小
    // private int maxConnections = ConfigManager.getInt(VConstants.SDK_CONNECTION_MAX_SIZE);
    private int maxConnections = ConfigManager.getPoolInt(VConstants.SDK_CONNECTION_MAX_SIZE); // 改成读工程中配置文件方式
     ...
     */
    public ConnectionPool(String jdbcDriver, String dbUrl, String dbUsername, String dbPass) {
