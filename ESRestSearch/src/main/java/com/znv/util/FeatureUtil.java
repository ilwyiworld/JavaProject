...
public class FeatureUtil {
    ...
    public static String getImageFeature(String imageData) {
        Properties productProps= PropertiesUtil.getProperties("conf.properties");
        String ip=productProps.getProperty("fss.server");
        String port=productProps.getProperty("fss.port");
        String result = null;
