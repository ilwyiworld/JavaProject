...
public class CallBackFunction {
    ...
    protected static void initConnection(String cLibraryLocation) {
        ...
        if(instanceSo==null){
            instanceSo=new CLibrary(cLibraryLocation);
        }
    }
    ...
    private static void startAnalyseVideo(JSONObject obj) {
        ...
        try{
            instanceSo.Cinitial(params.toString());
    ...
    private static void refreshAnalyseVideo(JSONObject obj) {
        ...
        try {
            ...
            params.model_path=model_path;
            params.loop_video=loop_video;
            CLibrary.Cinitial(params.toString());
        }catch (Exception e){
    ...
    public static void main(String[] args) {
        DataAbstractServerOpertion das=new DataAbstractServerOpertion("/data/lrj2904/ffmpeg-rstp/dll_test/test_so/libdll_detect.so");
