...
public class LoggerAdvice {
	...
	@Before("within(com.yiworld..*) && @annotation(loggerManage)")
	...
	@AfterReturning("within(com.yiworld..*) && @annotation(loggerManage)")
	public void addAfterReturningLogger(JoinPoint joinPoint, LoggerManage loggerManage) {
		logger.info("执行 " + loggerManage.description() + " 结束");
	}
	
	@AfterThrowing(pointcut = "within(com.yiworld..*) && @annotation(loggerManage)", throwing = "ex")
