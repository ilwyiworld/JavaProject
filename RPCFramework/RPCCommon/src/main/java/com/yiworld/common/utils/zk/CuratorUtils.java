package com.yiworld.common.utils.zk;
...
public final class CuratorUtils {
    ...
    private static final String CONNECT_STRING = "10.10.1.119:2181";
    ...
    public static void createPersistentNode(String path) {
        try {
            if (registeredPathSet.contains(path) || zkClient.checkExists().forPath(path) != null) {
                ...
                // eg: /my-rpc/com.yiworld.HelloService/127.0.0.1:9999
     ...
     *
     * @param serviceName 服务对象接口名 eg:com.yiworld.HelloService
     * @return 指定字节下的所有子节点
     */
