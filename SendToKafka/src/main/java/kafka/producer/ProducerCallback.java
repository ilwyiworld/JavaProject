...
public class ProducerCallback implements Callback {
     ...
     * @param data 要发送的记录
     */
    public ProducerCallback(ProducerBase producer, String data) {
        this(producer, data, DEFAULOGGERT_RESEND_COUNT);
    }
     ...
     * @param data 要发送的记录
     */
    public ProducerCallback(ProducerBase producer, String data, int resendCount) {
